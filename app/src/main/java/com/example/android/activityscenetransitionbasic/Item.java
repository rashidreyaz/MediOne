...
public class Item {
    ...
    public static Item[] ITEMS = new Item[] {
            new Item("Covid Important", "The Bengal 13", "flying_in_the_light.jpg"),
            new Item("Spreading Rate", "The Bengal 13", "lone_pine_sunset.jpg"),
            new Item("Details of covid", "The Bengal 13", "look_me_in_the_eye.jpg"),
            new Item("Flamingo", "Romain Guy", "rainbow.jpg"),
            new Item("Rainbow", "Romain Guy", "jelly_fish_2.jpg"),
